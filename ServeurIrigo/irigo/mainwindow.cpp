...
QByteArray MainWindow::splitIt(QByteArray input){
    ...
    m_timeAuto = dataDate.mid(16,4).append(";").append(dataDate.mid(12,2)).append(";").append(dataDate.mid(14,2)).append(";").append(dataDate.mid(8,2).append(";").append(dataDate.mid(10,2)).append(";").append(dataDate.mid(4,2)));
    while (data.length()) {
...
void MainWindow::directoryPerma(){
    ...
    m_folderPerma = new QDir(m_folderPathPerma);
    m_folderPerma->mkpath(m_folderPathPerma);
}

void MainWindow::newFile(){

    QString name = QString("ValeurIrigo_").append(QString::number(m_indexFile));            //Définit le nom du fichier
    QString m_filePath = QString(m_folderPathPerma).append(name).append(".txt");              //Ajoute l'extension du fichier
...
void MainWindow::moveFile(){
    ...
    QString filePermaPath = m_folderPathPerma.append(fileNamePerma).append(".txt");
